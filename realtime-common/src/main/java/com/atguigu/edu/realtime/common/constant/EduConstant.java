...
public class EduConstant {
   ...
   //13 退货原因
    ...
    //16 支付状态
    public static final String PAYMENT_STATUS_UNPAID="1601";//未支付
    public static final String PAYMENT_STATUS_PAID="1602";//已支付
    public static final String PAYMENT_STATUS_EXPIRE="1603";//过期
    public static final String PAYMENT_STATUS_FAILED="1604";//失败
    //24来源类型
